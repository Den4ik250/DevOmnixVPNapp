...
import 'package:devomnix/core/model/directories.dart';
...
import 'package:devomnix/hiddifycore/generated/v2/hcommon/common.pb.dart';
import 'package:devomnix/hiddifycore/generated/v2/hcore/hcore.pb.dart';
import 'package:devomnix/hiddifycore/generated/v2/hcore/hcore_service.pbgrpc.dart';
import 'package:devomnix/hiddifycore/init_signal.dart';
import 'package:devomnix/singbox/model/singbox_config_option.dart';
import 'package:devomnix/features/log/model/log_level.dart' as config_log_level;
import 'package:devomnix/singbox/model/core_status.dart';
import 'package:devomnix/singbox/model/warp_account.dart';

import 'package:devomnix/hiddifycore/core_interface/core_interface_wrapper_stub.dart'
    if (dart.library.io) 'package:devomnix/hiddifycore/core_interface/core_interface_wrapper.dart';
...
class HiddifyCoreService with InfraLogger {
  ...
  Future<void> init() async {
    await setup()
        ...
        .map((_) {
          loggy.info("DevOmnix-core setup done");
