...
import 'package:devomnix/core/theme/app_theme_mode.dart';
import 'package:devomnix/core/theme/theme_extensions.dart';
...
class AppTheme {
  ...
  ThemeData lightTheme(ColorScheme? lightColorScheme) {
    final ColorScheme scheme = lightColorScheme ?? ColorScheme.fromSeed(seedColor: const Color(0xFF0B3D91));
    return ThemeData(
      useMaterial3: true,
      colorScheme: scheme,
  ...
  ThemeData darkTheme(ColorScheme? darkColorScheme) {
    final ColorScheme scheme =
        darkColorScheme ?? ColorScheme.fromSeed(seedColor: const Color(0xFF0B3D91), brightness: Brightness.dark);
    return ThemeData(
      useMaterial3: true,
      colorScheme: scheme,
