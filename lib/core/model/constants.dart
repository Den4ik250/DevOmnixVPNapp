...
abstract class Constants {
  ...
  //
  // 20.08.2026 — переезд на 136.148.216.141 (Time4VPS, Stockholm).
  // nginx поднят и проверен снаружи: :80 отдаёт 200 на /health, /version,
  // /subscriptions/plans и на POST /auth/device. Порт по-прежнему не
  // указываем — :8000 наружу закрыт намеренно, вход только через nginx.
  //
