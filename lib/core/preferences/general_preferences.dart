...
abstract class Preferences {
  ...
  static final authCompleted = PreferencesNotifier.create<bool, bool>("auth_completed", false);

  static final telegramId = PreferencesNotifier.create<String, String>("telegram_id", "");
