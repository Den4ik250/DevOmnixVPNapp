...
import 'package:devomnix/core/db/db.dart';
...
import 'package:devomnix/features/profile/model/profile_failure.dart';
import 'package:devomnix/features/settings/data/config_option_repository.dart';
import 'package:devomnix/singbox/model/singbox_proxy_type.dart';
    ...
    final rs = await _httpClient
        .download(
          ...
          userAgent: _ref.read(ConfigOptions.useXrayCoreWhenPossible)
              ? _httpClient.userAgent.replaceAll("DevOmnixVPN", "HiddifyNextX")
              : null,
        )
        .catchError((err) {
        ...
        try {
          ...
          await httpClient.download(
            ...
            userAgent: ref.read(ConfigOptions.useXrayCoreWhenPossible)
                ? httpClient.userAgent.replaceAll('DevOmnixVPN', 'HiddifyNextX')
                : null,
          );
