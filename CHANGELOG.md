...
- Changed App name to **DevOmnix VPN**
- Changed App icon
...
- Added Chinese Taiwan language. [PR#410](https://github.com/devomnix/devomnix-vpnapp/pull/410) by [junlin03](https://github.com/junlin03) and [PR#491](https://github.com/devomnix/devomnix-vpnapp/pull/491) by [kouhe3](https://github.com/kouhe3)
- Added Japanese Readme. [PR#371](https://github.com/devomnix/devomnix-vpnapp/pull/371) by [Ikko Eltociear Ashimine](https://github.com/eltociear)

### Bug Fixes

- Fixed TLS Tricks bugs
- Fixed logs on iOS. [PR#414](https://github.com/devomnix/devomnix-vpnapp/pull/414) by [Amir Mohammadi](https://github.com/amirsaam) and [PR#416](https://github.com/devomnix/devomnix-vpnapp/pull/416) by [Ebrahim Tahernejad](https://github.com/EbrahimTahernejad)
- Fixed Android service mode
- Fixed UI inconsistencies
- Fixed Readme download URL. [PR#482](https://github.com/devomnix/devomnix-vpnapp/pull/482) by [Ali Afsharzadeh](https://github.com/guoard)
...
- Added iOS URL scheme. [PR#343](https://github.com/devomnix/devomnix-vpnapp/pull/343) by [Amir Mohammadi](https://github.com/amirsaam)
...
- Fixed infinite subscription expiry. [PR#334](https://github.com/devomnix/devomnix-vpnapp/pull/334) by [Pavel Volkov](https://github.com/pvolkov)
...
- Added Spanish language. [PR#314](https://github.com/devomnix/devomnix-vpnapp/pull/314) by [AvatarStark](https://github.com/AvatarStark)
...
- Improved TLS Fragmentation. [PR#12](https://github.com/UlfatovD/DevOmnixVPNapp-sing-box/pull/12) by [Kyōchikutō | キョウチクトウ](https://github.com/kyochikuto)
...
- Fixed localization mistakes in Chinese. [PR#288](https://github.com/devomnix/devomnix-vpnapp/pull/288) by [wldjdjsks](https://github.com/huajizhige)
...
- Fixed localization mistakes in Chinese. [PR#287](https://github.com/devomnix/devomnix-vpnapp/pull/287) by [Wu Jiahao](https://github.com/wujiahao15)
...
- Fixed modal bug where config options were unmodifiable. [PR#267](https://github.com/devomnix/devomnix-vpnapp/pull/267) by [在7楼](https://github.com/RayWangQvQ)
...
- Fixed localization mistakes in Russian. [PR#189](https://github.com/devomnix/devomnix-vpnapp/pull/189) by [jomertix](https://github.com/jomertix)
...
- Added **winget** Release
  - Now you're able to install and update DevOmnix VPN on Windows using [winget](https://learn.microsoft.com/en-us/windows/package-manager/winget/).
- Added Turkish Translations. [PR#173](https://github.com/devomnix/devomnix-vpnapp/pull/173) by [Hasan Karlı](https://github.com/hasankarli)
...
- Fixed translator script. [PR#108](https://github.com/devomnix/devomnix-vpnapp/pull/108) by [Hirad Rasoolinejad](https://github.com/Hiiirad)
- Fixed localization mistakes in Chinese. [PR#113](https://github.com/devomnix/devomnix-vpnapp/pull/113) and [PR#123](https://github.com/devomnix/devomnix-vpnapp/pull/123) by [Nyar233](https://github.com/Nyar233)
- Fixed localization mistakes in Chinese Readme. [PR#137](https://github.com/devomnix/devomnix-vpnapp/pull/137) by [wldjdjsks](https://github.com/huajizhige)
- Fixed localization mistakes in Chinese. [PR#138](https://github.com/devomnix/devomnix-vpnapp/pull/138) and [PR#165](https://github.com/devomnix/devomnix-vpnapp/pull/165) by [wldjdjsks](https://github.com/huajizhige)
- Fixed localization mistakes in Russian. [PR#155](https://github.com/devomnix/devomnix-vpnapp/pull/155), [PR#162](https://github.com/devomnix/devomnix-vpnapp/pull/162) and [PR#169](https://github.com/devomnix/devomnix-vpnapp/pull/169) by [solokot](https://github.com/solokot)
- Fixed linux build libs command. [PR#161](https://github.com/devomnix/devomnix-vpnapp/pull/161) by [Aloxaf](https://github.com/Aloxaf)
- Fixed localization mistakes in Russian. [PR#164](https://github.com/devomnix/devomnix-vpnapp/pull/164) and [PR#168](https://github.com/devomnix/devomnix-vpnapp/pull/168) by [jomertix](https://github.com/jomertix)
- Fixed localization mistakes in Chinese. [PR#179](https://github.com/devomnix/devomnix-vpnapp/pull/179) by [betaxab](https://github.com/betaxab)
- Fixed localization mistakes in Chinese Readme. [PR#172](https://github.com/devomnix/devomnix-vpnapp/pull/172) by [Locas](https://github.com/Locas56227)
...
- Added initial iOS implementation. [PR#98](https://github.com/devomnix/devomnix-vpnapp/pull/98) by [GFWFighter](https://github.com/GFWFighter)
...
- Fixed localization mistakes in Russian. [PR#95](https://github.com/devomnix/devomnix-vpnapp/pull/95) by [solokot](https://github.com/solokot)
- Fixed localization mistakes in Russian. [PR#74](https://github.com/devomnix/devomnix-vpnapp/pull/74) by [Elshad Guseynov](https://github.com/lifeindarkside)

[0.16.0.dev]: https://github.com/devomnix/devomnix-vpnapp/releases/tag/v0.16.0.dev
[0.14.1.dev]: https://github.com/devomnix/devomnix-vpnapp/releases/tag/v0.14.1.dev
[0.14.0.dev]: https://github.com/devomnix/devomnix-vpnapp/releases/tag/v0.14.0.dev
[0.13.6]: https://github.com/devomnix/devomnix-vpnapp/releases/tag/v0.13.6
[0.13.5.dev]: https://github.com/devomnix/devomnix-vpnapp/releases/tag/v0.13.5.dev
[0.13.4.dev]: https://github.com/devomnix/devomnix-vpnapp/releases/tag/v0.13.4.dev
[0.13.3.dev]: https://github.com/devomnix/devomnix-vpnapp/releases/tag/v0.13.3.dev
[0.13.2.dev]: https://github.com/devomnix/devomnix-vpnapp/releases/tag/v0.13.2.dev
[0.13.1.dev]: https://github.com/devomnix/devomnix-vpnapp/releases/tag/v0.13.1.dev
[0.13.0.dev]: https://github.com/devomnix/devomnix-vpnapp/releases/tag/v0.13.0.dev
[0.12.3]: https://github.com/devomnix/devomnix-vpnapp/releases/tag/v0.12.3
[0.12.2]: https://github.com/devomnix/devomnix-vpnapp/releases/tag/v0.12.2
[0.12.1]: https://github.com/devomnix/devomnix-vpnapp/releases/tag/v0.12.1
[0.12.0]: https://github.com/devomnix/devomnix-vpnapp/releases/tag/v0.12.0
[0.11.1]: https://github.com/devomnix/devomnix-vpnapp/releases/tag/v0.11.1
[0.11.0]: https://github.com/devomnix/devomnix-vpnapp/releases/tag/v0.11.0
[0.10.0]: https://github.com/devomnix/devomnix-vpnapp/releases/tag/v0.10.0
